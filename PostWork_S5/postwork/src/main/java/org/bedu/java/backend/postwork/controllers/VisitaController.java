...
public class VisitaController {
    ...
    @PostMapping
    public ResponseEntity<Visita> creaVisita(@RequestBody Visita visita) {
        return ResponseEntity.ok().build();
    }

    @PutMapping("{id}")
    public ResponseEntity<Visita> modificaVisita(@PathVariable("id") Long id, @RequestBody Visita visita) {
        return ResponseEntity.ok().build();
    }
